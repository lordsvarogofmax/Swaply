...
system_prompt = (
    ...
    "Отвечай чётко, по делу, без воды. Не пиши рассуждения, не используй теги  mw, не упоминай себя. "
    "Пиши ТОЛЬКО на русском языке. Никаких китайских иероглифов, никакого английского, кроме технических терминов (например, 'LED', 'PVC'). "
    "Не вставляй в ответы переменные, файловые пути, теги или HTML. "
